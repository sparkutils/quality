...
class AggregatesTest extends SharedPureConnectTests with VariableTestShims with AggregatesTestBase {
  ...
  test("mapAggrCountDSLTest") {
    doMapStructKeyAggrCountTest(mapStructKeyCountDSL)
  }

  test("mapAggrCountTest") {
    doMapAggrCountTest(mapCountExpr)
  }

  test("mapAggrCountDeprecatedTest") {
    doMapAggrCountTest(mapDeprecatedCountExpr)
  }
  ...
  test("mapStructKeyAggrCountTest") {
    doMapStructKeyAggrCountTest(mapStructKeyCountExpr)
  }

  test("mapStructKeyAggrCountDeprecatedTest") {
    doMapStructKeyAggrCountTest(mapStructKeyCountDeprecatedExpr)
  }
  ...
  test("mapAggrSumTest") {
    doMapAggrSumTest[Double](mapSumExpr)
  }

  test("mapAggrSumDeprecatedTest") {
    doMapAggrSumTest[Double](mapSumDeprecatedExpr)
  }
  ...
  test("mapAggrDecimalTest") {
    doMapAggrSumTest[java.math.BigDecimal](mapDecimalExpr)
  }

  test("mapAggrDecimalDSLTest") {
    doMapAggrSumTest[java.math.BigDecimal](mapDecimalDSL)
  }

  test("mapAggrOnePassTest") {
    doMapAggrOnePassTest(mapSumExpr, mapCountExpr)
  }

  test("mapAggrOnePassDeprecatedTest") {
    doMapAggrOnePassTest(mapSumDeprecatedExpr, mapDeprecatedCountExpr)
  }

  test("decimalPrecisionTest") {
    doDecimalPrecisionTest(expr("aggExpr('DECIMAL(37,18)', dec IS NOT NULL, sumWith(entry -> dec + entry ), returnSum()) as agg"))
  }

  test("decimalPrecisionExprDSLTest") {
  ...
  test("decimalPrecisionIncTest") {
    doDecimalPrecisionTest(expr("aggExpr('DECIMAL(37,18)', dec IS NOT NULL, inc(dec), returnSum()) as agg"))
  }

  test("decimalPrecisionIncDSLTest") {
    doDecimalPrecisionTestF(df => agg_expr(DecimalType(37, 18), df("dec").isNotNull, inc(df("dec")), return_sum) as "agg")
  }

}

trait AggregatesTestBase extends SharedPureConnectTests {
