...
trait RuleRunnerImports {
   ...
   * @return A Column representing the Quality DQ expression built from this ruleSuite
   */
  def dqRuleRunner(ruleSuite: RuleSuite, compileEvals: Boolean = false, resolveWith: Option[DataFrame] = None, variablesPerFunc: Int = 40, variableFuncGroup: Int = 20, forceRunnerEval: Boolean = false): Column =
