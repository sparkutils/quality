...
trait RuleEngineRunnerImports {
   ...
   */
  def ruleEngineRunner(ruleSuite: RuleSuite, compileEvals: Boolean = true,
    ...
    RuleEngineRunnerImpl.ruleEngineRunnerImpl(ruleSuite, compileEvals, debugMode, resolveWith, variablesPerFunc,
